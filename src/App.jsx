...
async function upsertTerceroSB(tercero) {
  ...
  try {
    ...
    if (existe && existe.length > 0) {
      ...
      Object.keys(tercero).forEach(k => { const val = tercero[k]; if (val !== undefined && val !== "" && val !== null && (!actual[k] || actual[k] === "")) { update[k] = val; } });
      await sbUpsert("terceros", update);
    } else { await sbUpsert("terceros", tercero); }
